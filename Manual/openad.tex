...
\small\lstinputlisting[frame=single]{Examples/OneMinute/head.prepped.xb.x2w.w2f.pp.f} %$
...
\lstinputlisting[frame=single,firstline=106,lastline=117]{Examples/OneMinute/head.prepped.xaif}
