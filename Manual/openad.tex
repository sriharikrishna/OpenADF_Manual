...
% -----------------------------------------------------------------------------------------
\section{Running the tool chain with the {\tt openad} script}
...
The most common setups are encapsulated in a Python script, the location of which is \lstinline{$OPENADROOT/bin/openad}. %$. 
...
Invoking the script with the \lstinline{-h} option displays the command-line options as follows. \\
...
where the following messages appear as output during the transformation process. \\
\hspace*{.05\textwidth}\begin{minipage}{.6\textwidth}
\fontsize{8pt}{9pt}
