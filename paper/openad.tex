...
\centering
\begin{tabular}{ccc}
\includegraphics[width=.3\textwidth]{cfg_ts}
&
\includegraphics[width=.3\textwidth]{cfg_tape}
&
\includegraphics[width=.3\textwidth]{cfg_adj}
\\
\em (a) & \em (b) & \em (c)
\end{tabular}
...
%#########################################################################################
\section{\OpenADF\ components}\label{sec:openadcomponents}
...
can be found on the \OpenADF\ website \cite{openadWeb}.
...
and side-effect analysis are also available to \OpenADF\ via
\OpenADFortTk.
