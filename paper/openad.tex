...
In \refsec{ssec:openadcomponents} we describe the language-independent 
...
by \OpenAnalysis, see \refsec{sssec:openanalysis}. Some are expressed 
...
the control flow reversal employed by the adjoint code transformation, see \refsec{ssec:cfReversal}.
\end{minipage}
}\\\hline
...
% -----------------------------------------------------------------------------------------
\subsection{Compiling and Linking}\label{ssec:compLink}
...
life applications. 
% -----------------------------------------------------------------------------------------
\subsection{Toy Example}\label{ssec:toyExample}
...
% -----------------------------------------------------------------------------------------
\subsubsection{Collect and Prepare Source Files} 
...
To perform the static code analysis as explained in \refsec{sssec:openanalysis}
...
\refsec{ssec:toyExample} indicates the need for a modification 
...
% -----------------------------------------------------------------------------------------
\subsubsection{Orchestrate a Reversal and Checkpointing Scheme}
Joint and split reversal, see \refsec{ssec:cgReversal} are two special cases 
...
% -----------------------------------------------------------------------------------------
\subsubsection{File I/O and Simple Loops}
...
% -----------------------------------------------------------------------------------------
\subsection{A Second Order Example}

{\color{red} candidate for removal, unless I get the fix in for the structure stuff}

% #########################################################################################
\section{Summary and Future Work}\label{sec:concl}
