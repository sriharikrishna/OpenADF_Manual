...
Each algorithm is also provided with a driver that encapsulates the algorithm 
...
a sequence of such graphs is created. Likewise the occurence 
...
%-----------------------------------------------------------------------------------------
\subsubsection{Mem/Ops Tradeoff}\label{sssec:MMTradeOff}
